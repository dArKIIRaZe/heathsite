...
export const metadata: Metadata = {
  title: "Ofsted/Performance Tables - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Ofsted/Performance Tables</h1>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable" id="sz-web-editing"><a href="/pdfs/146508_1.pdf" target="_blank" title="Click here to download the Ofsted Report May 23" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download the Ofsted Report May 23</span></span></a></div>
<p></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/assessment_2024.pdf" data-fileid="1172"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Click here to download the Assessment Results Summary 2024 <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/assessment_2024.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Click here to download the Assessment Results Summary 2024</span>
                                <span class="pdf-viewer-filesize">    266.84 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-1172-11726936e1681c95d" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/assessment_2024.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-1172-11726936e1681c95d").height(canvas.height);
                            $("#pdf-view-loading-1172-11726936e1681c95d").hide();
                            $("#pdf-view-1172-11726936e1681c95d").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1172-11726936e1681c95d").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/assessment_2024.pdf', document.getElementById('pdf-view-1172-11726936e1681c95d'));
            });
        </script>
...
<p></p>
<p>Please find below our most recent results, previous Ofsted reports, and relevant information from the Department for Education Performance Tables.</p>
<p><a href="https://heathprimary.schoolzineplus.co.uk/_file/media/48/assessment_results_2019.docx" target="_blank" class="sz-user-link link-document ">Assessment Summary 2019</a></p>
<p><a href="/pdfs/ofsted_report_.pdf" target="_blank" class="sz-user-link link-document ">Ofsted report </a></p>
<p><a href="https://www.compare-school-performance.service.gov.uk/school/146508/heath-primary-school/primary" target="_blank" class="sz-user-link linknewNode[0]-url ">School performance review</a></p>
