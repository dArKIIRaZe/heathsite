...
export const metadata: Metadata = {
  title: "Admissions - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1 style="text-align: left;"><span>Admissions</span></h1>
<p>If you wish your child to attend our school you will need to apply to the Local Authority by the due date.&nbsp;<a href="http://www.derbyshire.gov.uk/">Find out how to apply here.</a> Derbyshire County Council manage the admissions procedures for our school. Parents will be notified of a place as soon as possible, there may be a waiting list.</p>
<p>Check at&nbsp;<a href="http://www.derbyshire.gov.uk/admissions">www.derbyshire.gov.uk/admissions</a> for further information. Alternatively use the telephone number 01629 533190 for any required information concerning the admissions process.</p>
<p>&nbsp;</p>
<p>Visits by prospective parents are always welcome. We always welcome parents to come and meet the headteacher and have a tour of the school. If this is something you are intrested in please contact the school on <strong>01246 850277.</strong></p>
<p>Children who attend our Nursery are given opportunities to participate in whole school events such as assemblies, before moving into the Reception class. In the term before they are due to start full time education all children are invited to a series of visits to meet their teacher and to become familiar with their environment. Parents are invited to an induction meeting with the Foundation Stage staff where routines and expectations are shared. This is an ideal opportunity to have all your questions answered!</p>
<p><u><strong>Moving and transferring schools</strong></u></p>
<p>It is important that parents keep the school informed when they are considering changing schools, as we have a duty to inform the Authority of any child that we believe has left our school and has not provided any information on their destination and education provision. If we are unable to establish your child's new school, we would have to refer them as a missing child to the Children Missing from Education Officer. As a result, your child's name may be kept on a missing register and efforts will be made to trace them. It is also important to know about a new school so that we can send on your child's records.</p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/embark_school_admissions_arrangements_24_25_1_.pdf" target="_blank" title="Please click here for our EMBARK School Admissions Arrangements 2024-25" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Please click here for our EMBARK School Admissions Arrangements 2024-25</span></span></a></div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/embark_school_admissions_arrangements_25_26_2_.pdf" target="_blank" title="Please click here for our EMBARK School Admissions Arrangements 2025-26" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Please click here for our EMBARK School Admissions Arrangements 2025-26</span></span></a></div>
<h2>Elective Home Education</h2>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/elective-home-education-update-information-for-schools-and-parents-april-2019.pdf" target="_blank" title="Click here to download the Information for Elective Home Education" class="sz-web-a" rel="noopener"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download the Information for Elective Home Education</span></span></a></div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/ehe_guidance_for_parentsafterconsultationv2.2.pdf" target="_blank" title="Click here to download the Elective Home Education guidance from the DfE" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download the Elective Home Education guidance from the DfE</span></span></a></div>
<div class="ps_content_type_richtext">This is departmental guidance from the Department for Education. It is non-statutory, and has been produced to help parents understand their obligations and rights in relation to elective home education. This guidance is for parents, especially those educating children at home or considering doing so.</div>
<div class="ps_content_type_richtext">
<p><span>If you have any questions about elective home education please email:&nbsp;<a href="mailto:cs.ehe@derbyshire.gov.uk" id="LPlnk906709"><strong>cs.ehe@derbyshire.gov.uk</strong></a>&nbsp;or tel: 01629 532843.</span></p>
</div>
