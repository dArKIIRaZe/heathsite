...
export const metadata: Metadata = {
  title: "PE  - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
			...
			<h1>PE </h1>
                ...
                <div class="clearfix container content-wrap">
                                    <p><span>At Heath Primary School we are working hard to promote&nbsp;</span><span>PE, School Sport and Physical Activity. We are committed to developing the health and wellbeing of all the children.&nbsp;</span><span>The School Sports Premium funding allocated to the school by the Government has made it possible for our children to have access to Play, Learn and Compete events across Chesterfield. It also provides opportunities for teachers to work alongside skilled PE coaches delivering high quality PE sessions.&nbsp;</span></p>
<p><span>Read below to find out what we have been doing this term.&nbsp;</span></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/sports_premium_document_23_24.pdf" data-fileid="1213"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Sports Premium Document 23-24 <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-1213-12136936dfd7076d7" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/sports_premium_document_23_24.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-1214-12146936dfd718182").height(canvas.height);
                            $("#pdf-view-loading-1214-12146936dfd718182").hide();
                            $("#pdf-view-1214-12146936dfd718182").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1214-12146936dfd718182").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/pe_newsletter_autumn_.pdf', document.getElementById('pdf-view-1214-12146936dfd718182'));
            });
        </script>
...
<div></div>
<div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/pe_long_term_plan_2022.pdf" target="_blank" title="Click here to download the PE Long Term Plan 2022" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download the PE Long Term Plan 2022</span></span></a></div>
</div>
<p></p>
<p><a href="https://heathprimary.schoolzineplus.co.uk/pupil-premium-and-sports-premium" class="sz-user-link linknewNode[0]-url ">Click the link to view Sports Premium information</a></p>
<p></p>
            ...
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-1213-12136936dfd7076d7").height(canvas.height);
                            $("#pdf-view-loading-1213-12136936dfd7076d7").hide();
                            $("#pdf-view-1213-12136936dfd7076d7").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1213-12136936dfd7076d7").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/sports_premium_document_23_24.pdf', document.getElementById('pdf-view-1213-12136936dfd7076d7'));
            });
        \` }} />
