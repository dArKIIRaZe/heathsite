...
export const metadata: Metadata = {
  title: "Family Liaison Worker - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Family Liaison Worker</h1>
<p>As a school, we recognise the challenges family life presents and understand that life has its ups and downs from time to time. In school we have a full-time head of pastoral care in Mrs Hill, who you will all know very well. Recently, we have seen a reduction in the level of support for families in the area from Derbyshire and we wanted to ensure we could offer some of this provision through school.</p>
<p>To this end, we have our own Family Liaison Worker, Mrs McCubbin, whose role is to offer support and advice to children and their families around a range of issues which may include:</p>
<ul>
<li>Advice around a range of different parenting support methods.</li>
<li>Practical and emotional support for families, particularly at times of crisis.</li>
<li>Help and support around health, housing, finance, domestic violence, substance misuse etc.</li>
<li>Supporting vulnerable groups of pupils.</li>
<li>Supporting children and families around attendance and timekeeping issues.</li>
<li>Helping build positive working relationships between parents and their children.</li>
</ul>
<p>Please contact the office or speak directly to Mrs Hill or McCubbin who will be happy to help if you feel you need any support, or just a listening ear!</p>
