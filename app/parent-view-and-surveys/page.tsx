...
export const metadata: Metadata = {
  title: "Parent View and Surveys - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Parent View and Surveys</h1>
<p>Thank you to all who have registered on Parent View. We hope you are able to support the school by completing Ofsted's brief survey. This is another opportunity that, by sharing your views, you’ll be helping your child’s school to improve. You will also be able to see what other parents have said about our school. Or, if you want to, <a href="http://parentview.ofsted.gov.uk/parent-view-results" class="sz-user-link linknewNode[0]-url ">view the results</a> for any school in England.</p>
<p>As a school we try to engage with parents in a number of ways to gauge their views on the school. As well as an annual survey, where parents can raise anything they find positive about the school or an area we could develop, we also offer a parent forum where parents can come and meet and discuss a range of items in more detail.</p>
<p>We will add minutes of meetings as well as a summary of our own school surveys below.</p>
<p><strong>Ofsted Parent View&nbsp;</strong></p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="https://parentview.ofsted.gov.uk/" target="_blank" title="Click here for Ofsted Parent View" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here for Ofsted Parent View</span></span></a></div>
<p><strong></strong></p>
<p><strong>Parent Survery&nbsp;</strong></p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/survey_2021.pdf" target="_blank" title="Click here to view our parent survey results 2021" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to view our parent survey results 2021</span></span></a></div>
<p></p>
<p></p>
