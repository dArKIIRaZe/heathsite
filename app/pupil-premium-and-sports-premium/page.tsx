...
export const metadata: Metadata = {
  title: "Pupil Premium and Sports Premium - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Pupil Premium and Sports Premium</h1>
<h3><strong>What is the Pupil Premium Grant?</strong></h3>
<p>The Pupil Premium grant was introduced in April 2011 and is allocated to schools to work with pupils who have been registered for free school meals at any point in the last six years. Schools also receive funding for children who have been looked after recently and children of Service personnel.</p>
<div><span>The Pupil Premium grant is additional funding, paid directly to school which helps to improve the quality of your child's education. Our school may be entitled to funding for children whose parents have received any of the following:</span></div>
<div></div>
<div>
<ul>
<li><span>Income Support</span></li>
<li><span>Income Based Job Seekers Allowance</span></li>
<li><span>Child Tax Credit Only (with income up to £16,190) with no element of Working Tax Credit</span></li>
<li><span>National Asylum Seekers Support</span></li>
<li><span>Guarantee Element of the State Pension Credit</span></li>
<li><span>Employment and Support Allowance (income related)</span></li>
<li><span>Universal Credit (income dependant)<br></span></li>
</ul>
<div><span>If you are unsure whether your child would be eligible for Pupil Premium funding, please speak to Mrs Hermansen in the school office, who would be more than happy to help.&nbsp;</span></div>
<div><span>&nbsp;</span></div>
<div><span><span><span>Below is the school's annual report on how the Pupil Premium Grant is spent and how this has impacted the children. Keep a look out for Pupil Premium Parent Forum meetings, as we are always happy to hear your ideas and suggestions.</span></span></span></div>
<div><span><span><span></span></span></span></div>
<div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/2022_2025_pp_strategy.pdf" target="_blank" title="HPS Pupil Premium Strategy reviewed September 2023" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">HPS Pupil Premium Strategy reviewed September 2023</span></span></a></div>
<span><span><span></span></span></span></div>
<div></div>
</div>
<h3><strong>Sports Premium</strong></h3>
<div>PE and Sports Premium is a Government fund to help primary schools deliver an average of at least 60 minutes of activity per day. This is to ensure all children have the opportunity to live healthy and active lives. The money allocated to primary schools is expected to be sustainable and improve the PE experience for all children.&nbsp;</div>
<div>School spending must ensure the 5 key indicators are achieved:</div>
<div></div>
<ul>
<li>Engagement of all pupils in physical activity</li>
<li>The profile of PE and sport is raised across school as a tool for whole-school improvement</li>
<li>Increased knowledge, confidence and skills of all staff in teaching PE and sport</li>
<li>Broader experience of a range of sports and activities offered to all children</li>
<li>Increased participation in competitive sport</li>
</ul>
<div></div>
<div>Schools are expected to publish their spending of PE and Sports Premium on their website by the end of each academic year. Swimming data is also included in this report. Children are expected to be able to swim 25 metres, perform safe self-rescue and use a range of strokes effectively. The data includes the percentage of children who have achieved all of these.</div>
<div>
<p></p>
</div>
<ul>
<li><a href="/pdfs/evidencing_the_impact_of_the_primary_pe_and_sport_premium_template_july_2021_final_2_.pdf" class="sz-user-link link-document ">Click here to view the PE and Sports Premium document 2021-2022</a></li>
<li><a href="/pdfs/the_pe_and_sports_premium_funding_form_2022_2023.pdf" class="sz-user-link link-document ">Click here to view The PE and Sports Premium funding form 2022-2023</a></li>
<li><a href="/pdfs/sports_premium_document_23_24.pdf" class="sz-user-link link-document ">Click here to view The Sports Premium Document 2023 -2024</a></li>
<li><a href="/pdfs/20250730125022462.pdf" target="_blank" class="sz-user-link link-document ">Click here to view The Sports Premium Document 2024-2025</a></li>
</ul>
<div>
<div>
<p></p>
