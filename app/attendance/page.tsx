...
export const metadata: Metadata = {
  title: "Attendance - Heath Primary SchoolSchoolzine",
};
...
<p><span>To help children achieve their very best in school, it is important that they are good attenders and also punctual. Teachers welcome pupils into the classroom at 8.40am and registers are taken at 8.50am every day. The end of the school day is at 3:15pm everyday. This equates to 32 hours and 55 minutes a week.&nbsp;</span></p>
<p><span>It is important that your child is in school on time, every day in order for them to get the most out of their education. Being off can mean that your child falls behind with their learning and could miss out on exciting experiences. As a school, we are very proud of the amount of children who attend school regularly and, each half term, those children who have an attendance of above 96% (we know everyone gets ill sometimes) receive a certificate and are entered into a prize draw to win vouchers to spend on family activities or on Amazon. </span></p>
<p><span>We are required by law to monitor attendance. If you have any concerns or require any support with getting your child into school regularly, please do not hesitate to contact Mr Lynch or Mrs Hill, who will strive to help in any way possible.</span></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/hps_attendance_escalated_support_strategies.pdf" data-fileid="659"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">HPS Attendance Escalated Support Strategies.pdf <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-659-6596936e04eb03de" class="pdf-view HTML-only single-page" data-totalpages="0" style="height: auto; text-align: center; padding: 20px 0;">
        <img src="/images/media/absense.png" alt="Heath Primary School Attendance Policy Flowchart" style="max-width: 100%; height: auto; display: block; margin: 0 auto;" />
</div>
...
<div>
<p></p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/5_foundations_website_text.pdf" target="_blank" title="Click here to view our 5 Foundations of effective attendance practice. " class="sz-web-a" rel="noopener"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to view our 5 Foundations of effective attendance practice. </span></span></a></div>
</div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/attendance_policy_heath_primary_school_2023_24.pdf" target="_blank" title="Click here to access the Attendance Policy 23 24" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to access the Attendance Policy 23 24</span></span></a></div>
<p></p>
<h2><u>Requests for absence</u></h2>
<p>The Government made amendments to the Education (Pupil Registration) (England) Regulations 2006 which came into force on 1st&nbsp;September 2013. These state that Headteachers may not grant any leave of absence for holidays during the term time unless there are exceptional circumstances.</p>
<p>Parents needing leave of absence for exceptional circumstances should complete a form at least two weeks before the anticipated start date. The reason for the request should be given in detail.&nbsp;</p>
<p>If absence becomes a concern, in the first instance, school will look to support you to resolve any problems. During this process we may need to speak with your child.</p>
<p>As a school we will support with&nbsp;attendance by;</p>
<ul>
<li>sending letters home to alert parents to low attendance</li>
<li>arranging attendance panels to establish how we can support and explain next steps</li>
</ul>
<p><strong>The letter updating parents on the above as well as the forms to request authorisation for exceptional circumstances can be found below:</strong></p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/holiday_request_form.pdf" target="_blank" title="Please click here to download the Request of Absence Leave Form" class="sz-web-a" rel="noopener"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Please click here to download the Request of Absence Leave Form</span></span></a></div>
<p></p>
<p></p>
