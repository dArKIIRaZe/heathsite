...
export const metadata: Metadata = {
  title: "Prevent - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Prevent</h1>
<h2>Safeguarding pupils who are vulnerable to extremism; The Prevent Duty</h2>
<p>There is no place for extremist views of any kind at Heath Primary School. Through our ethos, values and behaviour policy, we provide a platform to ensure children are given the support to respect themselves and others.</p>
<p>We encourage pupils to respect the fundamental British values of: democracy, the rule of law, individual liberty and mutual respect and tolerance of those with different faiths and beliefs. Any prejudice, discrimination or extremist views including derogatory language, displayed by pupils, staff, visitors or parents will always be challenged and where appropriate, dealt with.</p>
<p>Heath Primary School is committed to working with the local authority and other local partners, families and communities to play a key role in ensuring young people and our communities are safe from the threat of terrorism.</p>
<p><strong>Point of contact should you have any concerns is Mr J Lynch.</strong></p>
<p>Please click on the link below to the official government document – The Prevent Duty.</p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/prevent_duty_guidance.pdf" data-fileid="991"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Click here to download the Prevent Duty Guidance <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/prevent_duty_guidance.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Click here to download the Prevent Duty Guidance</span>
                                <span class="pdf-viewer-filesize">    680.68 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/click_here_download_hps_extremism_and_radicalisation_policy.pdf" target="_blank" title="Click here download HPS Extremism and Radicalisation Policy" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here download HPS Extremism and Radicalisation Policy</span></span></a></div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/click_here_to_download_lockdown_procedures_2023.pdf" target="_blank" title="Click here to download the Lockdown Procedures" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download the Lockdown Procedures</span></span></a></div>
<p></p>
<p></p>
</div>
