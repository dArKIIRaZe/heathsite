...
export const metadata: Metadata = {
  title: "Term Dates - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1><span style="font-size: 20px;"><strong>Term Dates 2023-2024</strong></span></h1>
<h3>Inset Days&nbsp;</h3>
<p><strong>- Monday 23rd June 2025</strong></p>
<p><strong>- Monday 7th July 2025</strong><strong></strong></p>
<p><strong>- Thursday 4th September 2025</strong></p>
<p><strong>- Friday 5th September 2025</strong></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/school_term_dates_2024_to_2025.pdf" data-fileid="1091"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Click here to view our school term dates 2024-2025 <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-1091-10916936df8c8d160" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/school_term_dates_2024_to_2025.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-1091-10916936df8c8d160").height(canvas.height);
                            $("#pdf-view-loading-1091-10916936df8c8d160").hide();
                            $("#pdf-view-1091-10916936df8c8d160").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1091-10916936df8c8d160").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/school_term_dates_2024_to_2025.pdf', document.getElementById('pdf-view-1091-10916936df8c8d160'));
            });
        </script>
...
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/school-term-dates-2025-to-2026.pdf" target="_blank" title="Click here to view our school term dates 2025-2026" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to view our school term dates 2025-2026</span></span></a></div>
<p class="Clear sz-mce-clear mceNonEditable"></p>
<p></p>
<p></p>
