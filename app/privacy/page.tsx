...
export const metadata: Metadata = {
  title: "Privacy Policy - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="policyPadding clearfix">
                            <p>Heath Primary School understands that your privacy is important to you and that you care about how your personal data is used. we respect and value the privacy of everyone who visits this website, http://www.heath.derbyshire.sch.uk/ and will only collect and use personal data in ways that are described here, and in a way that is consistent with our obligations and your rights under the law.</p>
...
<p>Our<strong> site</strong> is operated by Heath Primary School. <br></p><p>Slack Lane<br> Heath Chesterfield S44 5RH</p>
<p><strong>Phone:</strong> 01246 850277<br><a href="mailto:office@heath.derbyshire.sch.uk" class="sz-user-link link-email ">office@heath.derbyshire.sch.uk</a></p><strong> </strong><p></p>
...
<li>The right to access the personal data we hold about you. Part 12 will tell you how to do this.</li>
...
<li>The right to be forgotten, i.e. the right to ask us to delete or otherwise dispose of any of your personal data that we have. Please contact us using the details in Part 14 to find out more.</li>
<li>The right to restrict (i.e. prevent) the processing of your personal data.</li>
<li>The right to object to us using your personal data for a particular purpose or purposes.</li>
<li>The right to data portability. This means that, if you have provided personal data to us directly, we are using it with your consent, and that data is processed using automated means, you can ask us for a copy of that personal data to re-use with another service or business in many cases.</li>
...
<p>Depending upon your use of our Site, we may collect some or all of the following personal data (please also see our cookies policy on our use of Cookies and similar technologies):</p>
<ul>
<li>Name;</li>
<li>Address;</li>
<li>Email address;</li>
...
<p>Third Parties (including Google, Facebook, Twitter) whose content appears on our Site may use third-party Cookies. Please refer to our <a href="/cookie-policy">cookies policy</a> for more information on controlling cookies. Please note that we do not control the activities of such third parties, nor the data that they collect and use themselves, and we advise you to check the privacy policies of any such third parties.</p>
...
<ul>
<li>Until our services are no longer required to use that data. Each person will be on a case by case basis. For more information please contact us.</li>
</ul>
<ul>
...
<p>we share your data with external third parties, as detailed below in Part 10, that are based outside of the EEA.</p>
<p>Please contact us using the details below in Part 14 for further information about the particular data protection mechanism used by us when transferring your personal data to a third country.</p>
<h2>8. Do You Share My Personal Data?</h2>
<p>we may sometimes contract with the following third parties to supply our website services. In some cases, those third parties may have access to some or all of your personal data that we hold.</p>
<ul>
<li>Schoolzine Pty Ltd – Website and communications platform developers.</li>
</ul>
...
<p>In addition to your rights under the GDPR, set out in Part 5, when<strong> </strong>you submit personal data via our Site, you may be given options to restrict our use of your personal data. In particular, we aim to give you strong controls on our use of your data for direct communication (including the ability to opt-out of receiving emails from us which you may do by unsubscribing using the links provided in our emails.</p>
...
<p><strong></strong>You may restrict our use of Cookies. For more information, our <a href="/cookie-policy">cookies policy</a>.</p>
...
<p>All subject access requests should be made in writing and sent to the email or postal addresses shown in Part 14.</p>
...
<h2>12. How Do You Use Cookies?</h2>
<p>our Site may place and access certain first-party Cookies on your computer or device. For full information about the cookies on our site, please refer to our <a href="/cookie-policy">cookies policy</a>.</p>
<h2>13. How Do I Contact You?</h2>
<p>To contact us about anything to do with your personal data and data protection, including to make a subject access request, please use the following:<br></p><p>Slack Lane<br> Heath Chesterfield S44 5RH</p>
<p><strong>Phone:</strong> 01246 850277<br><a href="mailto:office@heath.derbyshire.sch.uk" class="sz-user-link link-email ">office@heath.derbyshire.sch.uk</a></p><strong> </strong><p></p>
