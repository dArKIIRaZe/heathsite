...
export const metadata: Metadata = {
  title: "Behaviour and Rewards - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Behaviour and Rewards</h1>
<p>At Heath Primary School we expect all of our children to be kind, respectful and polite to each other and members of the school community. We encourage children to work hard and try their best in all aspects of school life and have several initiatives which we use to celebrate their successes.</p>
<p>All of our classroom teaching is rooted in mutual respect and positive praise: children are recognised for their efforts as well as their achievements. If a child is noticed doing something well, they may have their name written on a recognition board in their classroom, be given dojo points, be awarded a weekly certificate or be nominated for hot chocolate with the Head Teacher.</p>
<p>We are aware that sometimes things can go wrong and conflicts happen. As a school we are beginning to introduce restorative practices into our daily routines in order to empower children to understand their emotions so that they can empathise with others, resolve their own conflicts and take responsibility for their own actions.</p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/behaviour_policy_2022.pdf" target="_blank" title="Behaviour Policy 2022" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Behaviour Policy 2022</span></span></a></div>
<h2>Behaviour and S<span>anctions</span></h2>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/restorative_practice.pdf" target="_blank" title="Click here to view Restorative practice " class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to view Restorative practice </span></span></a></div>
<p></p>
<p></p>
