...
export const metadata: Metadata = {
  title: "OPAL - Heath Primary SchoolSchoolzine",
};
...
<h4 class="x_elementToProof" data-olk-copy-source="MessageBody">At Heath Primary School, we are committed to enriching children’s play experiences through the OPAL (Outdoor Play and Learning) programme. OPAL is a nationally recognised initiative that enhances the quality of play during&nbsp; lunchtimes, ensuring that every child has the opportunity to be active, creative, and engaged in meaningful play.</h4>
<div class="x_elementToProof">Through OPAL, we provide a range of open-ended resources and play opportunities that encourage teamwork, resilience, and problem-solving. Whether building dens, exploring nature, or engaging in imaginative games, children develop essential life skills while having fun. Our approach aligns with our school values of Respect, Achieve, Together: fostering a happy and inclusive play environment for all.</div>
<div class="x_elementToProof">To find out more about OPAL, please follow the link to their website:<span>&nbsp;</span><a class="x_OWAAutoLink" id="LPlnk446951" data-auth="NotApplicable" rel="noopener noreferrer" target="_blank" href="https://outdoorplayandlearning.org.uk/" title="https://outdoorplayandlearning.org.uk/" data-linkindex="0">https://outdoorplayandlearning.org.uk/</a>&nbsp;</div>
<div class="x_elementToProof"></div>
<div class="x_elementToProof">To support their adventures, please ensure your child has wellies and waterproofs in school. They’re loving the freedom to explore – and getting muddy is part of the fun!</div>
<div class="x_elementToProof">
<p class="Clear sz-mce-clear mceNonEditable"></p>
</div>
<div class="x_elementToProof">
<div data-sb-image-container="1"><a href="/images/image.png" data-lightbox="image.png" data-title="image.png" class="no-ajaxy" data-sb-image-container="1"><img src="/images/image.png" alt="image.png" width="595" height="224" class=" szImg" data-object_id="1206" data-object_ref="sb_cms_media_file" data_reference="/images/media/1206/image.png" data-lightboxed="true" data-externally-linked="false" data-custom-style-class="szImg" data-sb-image-container="1" style="display: block; margin-left: auto; margin-right: auto;"></a></div>
<div data-sb-image-container="1"></div>
<div data-sb-image-container="1">
<p class="Clear sz-mce-clear mceNonEditable"></p>
<h3>Please use the links below to view our OPAL play policies and guidance</h3>
<ul><li><a href="/pdfs/play_policy_1_.pdf" target="_blank" class="sz-user-link link-document ">Play Policy 2024-25</a></li>
<li><a href="/pdfs/heath_and_safety_executive_guidance.pdf" target="_blank" class="sz-user-link link-document ">Heath and Safety executive guidance</a></li>
<li><a href="/pdfs/managing_risk_in_play_guidance.pdf" target="_blank" class="sz-user-link link-document ">Managing Risk in Play - guidance</a></li>
</ul><h2><strong>Newsletters&nbsp;</strong></h2>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/opal_newsletter_1_.pdf" data-fileid="1210"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">OPAL Newsletter 1 <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/opal_newsletter_1_.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">OPAL Newsletter 1 </span>
                                <span class="pdf-viewer-filesize">    99.10 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<p></p>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/opal_newsletter_summer.pdf" data-fileid="1250"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">OPAL Newsletter Summer <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/opal_newsletter_summer.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">OPAL Newsletter Summer </span>
                                <span class="pdf-viewer-filesize">    381.16 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-1250-12506936dfe3edabb" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/opal_newsletter_summer.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="OPAL Newsletter Summer PDF"></iframe>
        </div></div>
<p></p>
</div>
<p></p>
</div>
<h3>Together with the children, we have created the Heath way to play. This allows all children to have fun in a safe environment</h3>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/play_charter_opal.pdf" data-fileid="1212"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">OPAL - Play Charter <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-1212-12126936dfe40029d" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/play_charter_opal.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                // Wait for PDFJS to be available
                function waitForPDFJS(callback) {
                    if (typeof PDFJS !== 'undefined' || (typeof window !== 'undefined' && (window.PDFJS || window.pdfjsLib || window.pdfjsDistBuildPdf))) {
                        var pdfjs = window.PDFJS || window.pdfjsLib || window.pdfjsDistBuildPdf || PDFJS;
                        if (window.pdfjsDistBuildPdf && !window.PDFJS) window.PDFJS = window.pdfjsDistBuildPdf.PDFJS || window.pdfjsDistBuildPdf;
                        callback();
                    } else {
                        setTimeout(function() { waitForPDFJS(callback); }, 100);
                    }
                }
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-1212-12126936dfe40029d").height(canvas.height);
                            $("#pdf-view-loading-1212-12126936dfe40029d").hide();
                            $("#pdf-view-1212-12126936dfe40029d").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1212-12126936dfe40029d").addClass("single-page");
                        }
                        ...
                        PDFJS.disableWorker = true;
                                            pdfjs.getDocument(url).then(renderPages).catch(function(error) {
                                console.error('Error loading PDF:', error);
                            });
                        } else {
                            console.error('PDFJS not available');
                        };

                }
                renderPDF('/pdfs/play_charter_opal.pdf', document.getElementById('pdf-view-1212-12126936dfe40029d'));
            });
        </script></div>
<p></p>
</div>
...
<div id="lightboxOverlay" class="lightboxOverlay" style="display: none;"></div><div id="lightbox" class="lightbox" style="display: none;"><div class="lb-outerContainer"><div class="lb-container"><img class="lb-image" alt="Lightbox Image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="><div class="lb-nav"><a class="lb-prev" name="Previous" href=""><span>Previous</span></a><a class="lb-next" name="Next" href=""><span>Next</span></a></div><div class="lb-loader"><a class="lb-cancel" name="Cancel"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-close" name="Close"></a></div></div></div></div>\` }} />
      ...
      {/* Load PDF.js before renderPDF scripts */}
      <Script id="pdfjs-init" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: \`\n        (function() {\n          if (typeof window !== 'undefined') {\n            function initPDFJS() {\n              if (window.pdfjsDistBuildPdf) {\n                window.PDFJS = window.pdfjsDistBuildPdf.PDFJS || window.pdfjsDistBuildPdf;\n                if (typeof PDFJS === 'undefined') {\n                  window.PDFJS = window.pdfjsDistBuildPdf;\n                }\n              } else if (window.pdfjsLib) {\n                window.PDFJS = window.pdfjsLib;\n              }\n              if (window.PDFJS) {\n                window.PDFJS.disableWorker = true;\n              }\n            }\n            initPDFJS();\n            setTimeout(initPDFJS, 100);\n            setTimeout(initPDFJS, 500);\n          }\n        })();\n      \` }} />
      <Script src="https://www.heath.derbyshire.sch.uk/app/js/tinymce/js/tinymce/tinymce.min.js" strategy="afterInteractive" key="https://www.heath.derbyshire.sch.uk/app/js/tinymce/js/tinymce/tinymce.min.js" />
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-1250-12506936dfe3edabb").height(canvas.height);
                            $("#pdf-view-loading-1250-12506936dfe3edabb").hide();
                            $("#pdf-view-1250-12506936dfe3edabb").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1250-12506936dfe3edabb").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/opal_newsletter_summer.pdf', document.getElementById('pdf-view-1250-12506936dfe3edabb'));
            });
        \` }} />
