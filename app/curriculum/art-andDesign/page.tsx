...
export const metadata: Metadata = {
  title: "Art & Design  - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <div>
<p><span style="font-size: 20px;"><strong>Art &amp; Design at Heath&nbsp;</strong></span></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/heath_primary_school_art_and_design_.pdf" data-fileid="467"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Heath_Primary_School_Art_and_Design_.pdf <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/heath_primary_school_art_and_design_.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Heath_Primary_School_Art_and_Design  pdf</span>
                                <span class="pdf-viewer-filesize">    983.88 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-467-4676936dfd28ddca" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/heath_primary_school_art_and_design_.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-467-4676936dfd28ddca").height(canvas.height);
                            $("#pdf-view-loading-467-4676936dfd28ddca").hide();
                            $("#pdf-view-467-4676936dfd28ddca").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-467-4676936dfd28ddca").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/heath_primary_school_art_and_design_.pdf', document.getElementById('pdf-view-467-4676936dfd28ddca'));
            });
        </script>
