...
export const metadata: Metadata = {
  title: "Science - Heath Primary SchoolSchoolzine",
};
...
<p class="x_elementToProof"><span>Science is a spark of wonder that ignites curiosity that takes us on a journey of discovery. By following the footsteps of scientists from the past, children will learn how to make their own impact in the future. </span><span>Science at Heath Primary School should promote and nurture curiosity and wonder. Children are encouraged to generate their own questions as well as the approaches to finding the answers. Learners are encouraged to make mistakes on the path to discovery. Practical investigations create opportunities to develop enquiring minds in search of answers. Children develop respect for the natural world and our position in it, recognising&nbsp;that science impacts all aspects of our lives.</span></p>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/science_curriculum.pdf" data-fileid="1191"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Science Curriculum <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/science_curriculum.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Science Curriculum</span>
