...
export const metadata: Metadata = {
  title: "Curriculum - Heath Primary SchoolSchoolzine",
};
			...
			<li class="sub-menu">
			 <a href="/curriculum" title="Curriculum" class="sf-with-ul">
			 	<div class="stickyHidden"><i class="fa fa-book"></i><span>Curriculum</span></div>
									...
									<a href="/curriculum/assemblies" title="Assemblies">
										<div>
											Assemblies
																					</div>
									</a>
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1><span style="font-size: 18px;"><span style="font-size: 20px;"><strong>Curriculum</strong></span></span></h1>
<div style="border-image-outset: 0; border-image-repeat: stretch; border-image-slice: 100%; border-image-source: none; border-image-width: 1; color: #000000; font-family: Calibri,Arial,Helvetica,sans-serif; font-size: 12pt; font-size-adjust: none; font-stretch: inherit; font-style: inherit; font-variant: inherit; font-weight: inherit; letter-spacing: normal; line-height: inherit; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; vertical-align: baseline; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px; padding: 0px; margin: 0px; border: 0px none currentColor;">
<p><span style="font-size: 16px;">At Heath, our children access a broad and balanced curriculum through global and local themes whilst covering the National Curriculum. Each theme explores skills and subject specific knowledge. Our aim is to provide children with a curriculum that is taught sequentially which builds on previous learning to deepen their knowledge each year, preparing children for future learning and employment. These themes are delivered through carefully selected topics focused around a high-quality text. Through these topics our children gain a love of learning and develop their talents and personal interests. Below you will find our curriculum plans. To find out more about our curriculum, please speak to the school office on 01246 850277 who will put you in contact with the appropriate person.</span><br><span style="font-size: 14px; font-style: inherit; font-variant-ligatures: inherit; font-variant-caps: inherit; font-weight: inherit;"></span></p>
<div>
<p class="Clear sz-mce-clear mceNonEditable"></p>
<h3><strong><span style="font-size: 20px;">Curriculum Overview</span></strong></h3>
<div><a href="/pdfs/nursery_2s_website_overview._spring_1.pdf" target="_blank" class="sz-user-link link-document sz-user-link link-document ">Nursery 2s Spring Term 1 Overview</a></div>
<div></div>
<div><a href="/pdfs/reception_website_overview._spring_1.pdf" target="_blank" class="sz-user-link link-document sz-user-link link-document ">Reception Spring Term 1 Overview </a></div>
<div></div>
<div><a href="/pdfs/ks1_spring_term_1_overview_1_.pdf" target="_blank" class="sz-user-link link-document sz-user-link link-document sz-user-link link-document ">KS1 Spring Term 1 Overview</a></div>
<div></div>
<div><a href="/pdfs/lks2_spring_term_1_overview.pdf" target="_blank" class="sz-user-link link-document sz-user-link link-document ">LKS2 Spring Term 1 Overview</a></div>
<div></div>
<div><a href="/pdfs/uks2_spring_term_1_overview_1_.pdf" target="_blank" class="sz-user-link link-document sz-user-link link-document ">UKS2 Spring Term 1 Overview</a></div>
<div></div>
<span style="font-size: 20px;"><strong><span style="font-style: inherit; font-variant-ligatures: inherit; font-variant-caps: inherit;">Curriculum Offer&nbsp;</span></strong></span></div>
<div>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/heath_s_curriculum_offer.pdf" data-fileid="844"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Heath Curriculum Offer.pdf <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/heath_s_curriculum_offer.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Heath Curriculum Offer _pdf</span>
                                <span class="pdf-viewer-filesize">    600.14 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-844-8446936df9557dba" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/heath_s_curriculum_offer.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
    

</div>
</div>
<p><strong style="font-size: 20px; font-style: inherit; font-variant-ligatures: inherit; font-variant-caps: inherit;">Curriculum Intent Statements</strong></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/intent_statements.pdf" data-fileid="1188"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Intent statements <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/intent_statements.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Intent statements</span>
                                <span class="pdf-viewer-filesize">    966.85 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<div>
<p><span style="font-size: 20px;"><strong>Global Themes Progression Document</strong></span></p>
<p><span style="font-size: 16px;">Our curriculum has been created around six global themes, which have links to Oxfam's Global Citezenship. The following progression document maps out how these themes are developed throughout a child's school journey. Children will have the opportunity to explore these themes within their curriculum lessons, whole-school assemblies, PSHE work and class circles.&nbsp;</span></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/heath_s_curriculum_offer.pdf" data-fileid="845"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Global Themes Progression Document <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/global_themes_progression_document.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Global Themes Progression Document </span>
                                <span class="pdf-viewer-filesize">    273.46 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-845-8456936df9566fd4" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/global_themes_progression_document.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
    

</div>
</div>
<p><strong style="font-size: 20px; font-style: inherit; font-variant-ligatures: inherit; font-variant-caps: inherit;">Curriculum Maps</strong></p>
</div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable" id="sz-web-editing"><a href="/pdfs/embark_eyfs_curriculum_map.pdf" target="_blank" title="Click here to download HPS EYFS Curriculum Map" class="sz-web-a" rel="noopener"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download HPS EYFS Curriculum Map</span></span></a></div>
</div>
<div><span style="font-size: 14px; font-style: inherit; font-variant-ligatures: inherit; font-variant-caps: inherit; font-weight: inherit;"></span>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/2_year_curriculum_map_ks1.pdf" target="_blank" title="Click here to download HPS 2-year Curriculum Map KS1" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download HPS 2-year Curriculum Map KS1</span></span></a></div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable" id="sz-web-editing"><a href="/pdfs/2_year_curriculum_map_lks2_.pdf" target="_blank" title="Click here to download HPS 2-year Curriculum Map LKS2" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download HPS 2-year Curriculum Map LKS2</span></span></a></div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/2_year_curriculum_map_uks2_.pdf" target="_blank" title="Click here to download HPS 2-year Curriculum Map UKS2" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download HPS 2-year Curriculum Map UKS2</span></span></a></div>
</div>
</div>
...
<div style="border-image-outset: 0; border-image-repeat: stretch; border-image-slice: 100%; border-image-source: none; border-image-width: 1; color: #000000; font-family: Calibri,Arial,Helvetica,sans-serif; font-size: 12pt; font-size-adjust: none; font-stretch: inherit; font-style: inherit; font-variant: inherit; font-weight: inherit; letter-spacing: normal; line-height: inherit; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; vertical-align: baseline; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px; padding: 0px; margin: 0px; border: 0px none currentColor;"><br><span style="font-size: 18px;"></span></div>
<div style="border-image-outset: 0; border-image-repeat: stretch; border-image-slice: 100%; border-image-source: none; border-image-width: 1; color: #000000; font-family: Calibri,Arial,Helvetica,sans-serif; font-size: 12pt; font-size-adjust: none; font-stretch: inherit; font-style: inherit; font-variant: inherit; font-weight: inherit; letter-spacing: normal; line-height: inherit; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; vertical-align: baseline; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px; padding: 0px; margin: 0px; border: 0px none currentColor;">
<div></div>
