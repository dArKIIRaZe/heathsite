...
export const metadata: Metadata = {
  title: "Explorers - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <p><strong><span style="font-size: 20px;">Explorers</span></strong></p>
<div>
<div>
<p></p>
</div>
...
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/the_explorers.pdf" data-fileid="775"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Explorers <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/the_explorers.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Explorers</span>
                                <span class="pdf-viewer-filesize">    532.59 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-775-7756936dfde4fde5" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/the_explorers.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-775-7756936dfde4fde5").height(canvas.height);
                            $("#pdf-view-loading-775-7756936dfde4fde5").hide();
                            $("#pdf-view-775-7756936dfde4fde5").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-775-7756936dfde4fde5").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/the_explorers.pdf', document.getElementById('pdf-view-775-7756936dfde4fde5'));
            });
        </script>
