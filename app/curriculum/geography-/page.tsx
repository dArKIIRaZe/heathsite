...
export const metadata: Metadata = {
  title: "Geography  - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
			...
			<h1>Geography</h1>
                ...
                <div class="clearfix container content-wrap">
                                    <div>
<p><span>Our Geography intent at Heath is to inspire pupils with a curiosity and fascination about the world. Geography is, by nature, an investigative subject, which develops respect for global issues as well as an understanding of concepts, knowledge and skills.&nbsp; Through geographical investigation children learn and appreciate the connection between the near and far, the Earth’s key physical and human processes, people and environments, the economic and the social. Geographical skills are transferable to other curriculum areas by enabling children to identify a question, guide an investigation, organise information, suggest an explanation or assist decision-making. Crucially, the geography curriculum also needs to engender the excitement, creativity and critical thinking about the world that will equip young people to make their own way in it. Our geography curriculum therefore offers a uniquely powerful way of seeing the world and creating geographers and empowered, responsible global citizens in the real world today.</span></p>
</div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/geography_curriculum.pdf" data-fileid="1116"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Geography Curriculum <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/geography_curriculum.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Geography Curriculum</span>
                                <span class="pdf-viewer-filesize">    728.00 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
