...
export const metadata: Metadata = {
  title: "EYFS - Heath Primary SchoolSchoolzine",
};
...
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/eyfs_provision_at_heath.pdf" data-fileid="784"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">EYFS Provision at Heath <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-784-7846936dfbedc8e7" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/eyfs_provision_at_heath.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-784-7846936dfbedc8e7").height(canvas.height);
                            $("#pdf-view-loading-784-7846936dfbedc8e7").hide();
                            $("#pdf-view-784-7846936dfbedc8e7").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-784-7846936dfbedc8e7").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/eyfs_provision_at_heath.pdf', document.getElementById('pdf-view-784-7846936dfbedc8e7'));
            });
        </script>
...
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/eyfs_intent_statement.pdf" data-fileid="457"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">EYFS Intent statement <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/eyfs_intent_statement.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">EYFS Intent statement </span>
                                <span class="pdf-viewer-filesize">    430.65 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/learning_in_the_early_years_at_hps.pdf" data-fileid="459"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Learning in Early Years at HPS <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/learning_in_the_early_years_at_hps.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Learning in Early Years at HPS</span>
                                <span class="pdf-viewer-filesize">    445.10 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/reception_overview.pdf" data-fileid="1063"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Reception Overview <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/reception_overview.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Reception Overview</span>
                                <span class="pdf-viewer-filesize">    272.37 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
