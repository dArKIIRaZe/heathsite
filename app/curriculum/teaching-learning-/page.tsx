...
export const metadata: Metadata = {
  title: "Teaching & Learning  - Heath Primary SchoolSchoolzine",
};
...
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/adaptive_teaching.pdf" data-fileid="1181"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Adaptive Teaching <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-1181-11816936df9b5ad4b" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/adaptive_teaching.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="Adaptive Teaching PDF"></iframe>
        </div>
...
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/feedback_and_marking_guidance.pdf" data-fileid="1253"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Feedback_and_Marking_Guidance.pdf <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-1253-12536936df9b62e6d" class="pdf-view HTML-only single-page" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/feedback_and_marking_guidance.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="Feedback and Marking Guidance PDF"></iframe>
        </div>
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-1181-11816936df9b5ad4b").height(canvas.height);
                            $("#pdf-view-loading-1181-11816936df9b5ad4b").hide();
                            $("#pdf-view-1181-11816936df9b5ad4b").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1181-11816936df9b5ad4b").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/adaptive_teaching.pdf', document.getElementById('pdf-view-1181-11816936df9b5ad4b'));
            });
        \` }} />
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-1253-12536936df9b62e6d").height(canvas.height);
                            $("#pdf-view-loading-1253-12536936df9b62e6d").hide();
                            $("#pdf-view-1253-12536936df9b62e6d").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-1253-12536936df9b62e6d").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/feedback_and_marking_guidance.pdf', document.getElementById('pdf-view-1253-12536936df9b62e6d'));
            });
        \` }} />
