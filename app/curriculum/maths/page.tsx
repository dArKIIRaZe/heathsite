...
export const metadata: Metadata = {
  title: "Maths - Heath Primary SchoolSchoolzine",
};
...
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/heath_primary_school_calculation_policy.pdf" data-fileid="807"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Heath Primary School Calculation Guidance <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/heath_primary_school_calculation_policy.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Heath Primary School Calculation Guidance</span>
                                <span class="pdf-viewer-filesize">    637.85 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-807-8076936dfaf91144" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/heath_primary_school_calculation_policy.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="Heath Primary School Calculation Policy PDF"></iframe>
        </div>
...
<p></p>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/maths_at_heath_primary_school_2.pdf" data-fileid="805"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Maths At Heath Primary School <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/maths_at_heath_primary_school_2.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Maths At Heath Primary School</span>
                                <span class="pdf-viewer-filesize">    608.30 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-805-8056936dfaf993fa" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/maths_at_heath_primary_school_2.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="Maths At Heath Primary School PDF"></iframe>
        </div>
...
<p></p>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/maths_pupil_voice_for_website.pdf" data-fileid="762"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Maths Pupil Voice <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/maths_pupil_voice_for_website.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Maths Pupil Voice </span>
                                <span class="pdf-viewer-filesize">    472.05 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-762-7626936dfaf9fa91" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/maths_pupil_voice_for_website.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-807-8076936dfaf91144").height(canvas.height);
                            $("#pdf-view-loading-807-8076936dfaf91144").hide();
                            $("#pdf-view-807-8076936dfaf91144").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-807-8076936dfaf91144").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/heath_primary_school_calculation_policy.pdf', document.getElementById('pdf-view-807-8076936dfaf91144'));
            });
        \` }} />
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-805-8056936dfaf993fa").height(canvas.height);
                            $("#pdf-view-loading-805-8056936dfaf993fa").hide();
                            $("#pdf-view-805-8056936dfaf993fa").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-805-8056936dfaf993fa").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/maths_at_heath_primary_school_2.pdf', document.getElementById('pdf-view-805-8056936dfaf993fa'));
            });
        \` }} />
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-762-7626936dfaf9fa91").height(canvas.height);
                            $("#pdf-view-loading-762-7626936dfaf9fa91").hide();
                            $("#pdf-view-762-7626936dfaf9fa91").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-762-7626936dfaf9fa91").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/maths_pupil_voice_for_website.pdf', document.getElementById('pdf-view-762-7626936dfaf9fa91'));
            });
        \` }} />
            ...
            $(function () {
                ...
                waitForPDFJS(function() {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-765-7656936dfafa620c").height(canvas.height);
                            $("#pdf-view-loading-765-7656936dfafa620c").hide();
                            $("#pdf-view-765-7656936dfafa620c").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-765-7656936dfafa620c").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/working_walls_.pdf', document.getElementById('pdf-view-765-7656936dfafa620c'));
            });
        \` }} />
