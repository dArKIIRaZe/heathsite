...
export const metadata: Metadata = {
  title: "GDPR - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1><span style="font-size: 16px;"><strong>GDPR</strong> (General Data Protection Regulation)</span></h1>
<p><span style="font-size: 16px;"></span></p>
<p>All staff within Heath Primary School take their UK GDPR and data protection obligations very seriously and is therefore a main priority within our school.</p>
<p></p>
<p>Our Data Protection Officer is John Walker whose details can be found on the trust website.</p>
<p>For specific requests or further information please contact Mr Lynch who is our designated UK GDPR lead in school via <a href="mailto:office@heath.derbyshire.sch.uk">office@heath.derbyshire.sch.uk</a></p>
<p></p>
<p>Please follow the link below to view the trust wide UK GDPR and data protection policies and information</p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="https://embarkfederation.com/ukgdprandcompliance" target="_blank" title="Click here for the EMBARK Trust GDPR &amp; Privacy notices" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here for the EMBARK Trust GDPR &amp; Privacy notices</span></span></a></div>
<p>Should you wish to request paper copies or further details with reference to GDPR please contact the school's Data Compliance lead via the school office.</p>
<p></p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="https://heathprimary.schoolzineplus.co.uk/_file/media/354/sar_request_form_2021_.docx" target="_blank" title="Click here to download the subject access request form" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-download"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download the subject access request form</span></span></a></div>
<p class="Clear sz-mce-clear mceNonEditable"></p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/withdrawal_of_consent_pupil.pdf" data-fileid="971"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Click here to download the Withdrawal of Consent for Pupil form <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/withdrawal_of_consent_pupil.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Click here to download the Withdrawal of Consent for Pupil form </span>
                                <span class="pdf-viewer-filesize">    739.49 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/withdrawal_of_consent_adult.pdf" data-fileid="972"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Click here to download the Withdrawal of Consent for Adult form <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/withdrawal_of_consent_adult.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Click here to download the Withdrawal of Consent for Adult form</span>
                                <span class="pdf-viewer-filesize">    737.33 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
