        ...
        <ul>
                        ...
                        <a href="/" title="Home">
                            Home
                                    ...
                                    <li>
                        <a href="javascript:;" title="Key Information">
                            Key Information
                        </a>
                                        ...
                                        <a href="/GDPR" title="GDPR">
                                            GDPR
                                                                    ...
                                                                    <li>
                                        <a href="/governors" title="Governors">
                                            Governors
                                        </a>
                                    </li>
                                                                    <li>
                                        ...
                                        <a href="/ofsted-performance-tables" title="Ofsted/Performance Tables">
                                            Ofsted/Performance Tables
                                                                    ...
                                                                    <li>
                                        <a href="/policies" title="Policies - Old tab">
                                            Policies - Old tab
                                        </a>
                                    </li>
                                                                    <li>
                                    ...
                                    <li>
                        <a href="javascript:;" title="Safeguarding">
                            Safeguarding
                        </a>

                                                    <ul>
                                                                    <li>
                                        <a href="/school-policies" title="Safeguarding (Including Policies)">
                                            Safeguarding (Including Policies)
                                        </a>
                                    </li>
                                                                    <li>
                                    ...
                                    <li>
                        <a href="javascript:;" title="Parent Area">
                            Parent Area
                        </a>
                                        ...
                                        <a href="/pupil-voice" title="Pupil Voice">
                                            Pupil Voice
                                                                    ...
                                                                    <li>
                                        <a href="/parent-area/remote-learning" title="Remote Learning">
                                            Remote Learning
                                        </a>
                                    </li>
                                                                    <li>
                        ...
                        <a href="/curriculum" title="Curriculum">
                            Curriculum
                                    ...
                                    <li>
                        <a href="javascript:;" title="School Community">
                            School Community
                        </a>

                                                    <ul>
                                                                    <li>
                                        <a href="/staff-team" title="Staff Team">
                                            Staff Team
                                        </a>
                                    </li>
                                                                    <li>
                                        ...
                                        <a href="/after-and-before-school-club" title=" Before and After School Club">
                                             Before and After School Club
                                                                    ...
                                                                    <li>
                                        <a href="/a-school-day-a-day-in-the-life-of-heath-" title="A School Day (A day in the life of Heath)">
                                            A School Day (A day in the life of Heath)
                                        </a>
                                    </li>
                                                                    <li>
                                        <a href="http://www.letslocalise.co.uk/school/heath-primary-school/sch128250/campaigns/" title="Lets Localise ">
                                            Lets Localise 
                                        </a>
                                    </li>
                                                                    <li>
                                        <a href="/schoolcommunity/local-clubs" title="Local Clubs">
                                            Local Clubs
                                        </a>
                                    </li>
                                                                    <li>
                                        ...
                                        <a href="/family-liaison-worker" title="Family Liaison Worker">
                                            Family Liaison Worker
                                                                    ...
                                                                    <li>
                                        <a href="/schoolcommunity/early-help-offer" title="Early Help Offer ">
                                            Early Help Offer 
                                        </a>
                                    </li>
                                                                    <li>
