...
export const metadata: Metadata = {
  title: " Before and After School Club - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <h1>Before and After School Club</h1>
<p>Since September 2017, we&nbsp;have been able&nbsp;to offer extended provision at Heath Primary School. This incorporates a before and after school club. Any bookings or queries should go through the main school office.</p>
<p>Our club is run by a fantastic and dedicated team of Teaching Assistants who work at Heath Primary during school hours and are fully qualified in all relevant training following school guidelines. We offer care for children from nursery to year 6.&nbsp;&nbsp;</p>
<p>We pride ourselves in building good relationships with the children and parents/carers and liaise closely with the school. &nbsp;</p>
<p>Each week we focus on different topics relating to the time of year, children's interests or events happening in school; such as arts week, friendship week and world book day, where there are fun indoor and outdoor games, crafts, baking and free play activities planned. It is our aim to give the children a wide and exciting range of experiences, having specialised visitors come into school such as the local fire service and animal handling sessions with Pets at Home.&nbsp;&nbsp;</p>
<p>Below is a flyer showing prices for the before &amp; after school provision. This service is available to book through Parent Pay: <a href="https://app.parentpay.com/">https://app.parentpay.com/</a>&nbsp;</p>
<p><span>T</span><span>o</span><span> access</span><span> the</span><span> “Clubs”</span><span> section</span><span> on</span><span> ParentPay:</span><br><span>•</span><span> Login</span><span> to</span><span> ParentPay</span><br><span>•</span><span> Click</span><span> on</span><span> the</span><span> child</span><span> you</span><span> wish</span><span> to</span><span> books</span><span> clubs</span><span> for</span><br><span>•</span><span> Select</span><span> “Clubs”</span><span> from</span><span> the</span><span> menu</span><span> on</span><span> the</span><span> left</span><br><span>•</span><span> Click</span><span> on</span><span> the</span><span> club</span><span> you</span><span> would</span><span> like</span><span> to</span><span> book,</span><span> and</span><span> select</span><span> the</span><span> sessions</span><span> you</span><span> require.</span><br><span>•</span><span> Click</span><span> “book</span><span> selected</span><span> sessions”</span><span> and</span><span> confirm.</span></p>
<p><span>Please visit this link for a short video tutorial on how to use the&nbsp;system <a href="https://parentpay.wistia.com/medias/f7e9aflmga" data-name="rich_text_link" class="css-gr5ouq" target="_blank" rel="noopener noreferrer">https://parentpay.wistia.com/medias/f7e9aflmga</a></span></p>
<p>&nbsp;</p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/before_after_school_provision_fees_feb_2025.pdf" data-fileid="1226"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Before_After_School_Provision_fees_Feb_2025.pdf <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/before_after_school_provision_fees_feb_2025.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Before_After_School_Provision_fees_Feb_2025 _pdf</span>
                                <span class="pdf-viewer-filesize">    537.10 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
