...
<h1>Clubs</h1>
<p>At Heath Primary School, we are lucky enough to have a staff team with diverse talents and interests, which mean that we are able to offer a range of extra-curricular activities for our children. Clubs take place during the school day, at lunchtimes and after school. We offer a range of clubs encompassing all curriculum areas and others just for fun. Some clubs are open to the whole school and others are open to specific age groups. Examples of the clubs we are offering this year are below.</p>
<h2><strong><span style="font-size: 18px;">Dance Club</span></strong></h2>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/scarefest.pdf" data-fileid="988"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Scarefest.pdf <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/scarefest.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Scarefest _pdf</span>
                                <span class="pdf-viewer-filesize">    696.33 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-988-9886936df4f389fc" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/scarefest.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
            ...
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-988-9886936df4f389fc").height(canvas.height);
                            $("#pdf-view-loading-988-9886936df4f389fc").hide();
                            $("#pdf-view-988-9886936df4f389fc").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-988-9886936df4f389fc").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
                ...
                renderPDF('/pdfs/scarefest.pdf', document.getElementById('pdf-view-988-9886936df4f389fc'));
            });
        \` }} />
...
\` }} />
      <Script id="inline-11" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: \`
    var actualCaretPositionBookmark;
\` }} />
