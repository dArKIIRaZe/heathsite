...
<h1>Travel - <span>ModeShift STARS</span></h1>
<p><span></span></p>
<p>Modeshift STARS is the national schools awards scheme that has been established to recognise schools that have demonstrated excellence in supporting cycling, walking and other forms of sustainable travel.</p>
<p></p>
<p>The scheme encourages schools across the country to join in a major effort to increase levels of sustainable and active travel in order to improve the health and well-being of children.</p>
<p>&nbsp;</p>
<p>Every school in England can participate in Modeshift STARS for free and on completion of an application will automatically have a national standard School Travel Plan.</p>
<p>&nbsp;</p>
<div data-sb-image-container="1"><a href="https://uk.sz-cdn.net/heathprimary/media/560/220622025703134/600x448/img_6603.jpg" data-lightbox="IMG_6603.JPG" data-title="IMG_6603.JPG" class="no-ajaxy" data-sb-image-container="1"><img src="/images/img_6603.jpg" alt="IMG_6603.JPG" width="600" height="448" class=" szImg" data-object_id="560" data-object_ref="sb_cms_media_file" data_reference="/images/media/560/img_6603.jpg" data-lightboxed="true" data-externally-linked="false" data-custom-style-class="szImg" data-sb-image-container="1" style="display: block; margin-left: auto; margin-right: auto;"></a></div>
<p>Heath Primary School is currently working towards achieving bronze level and in January 2022 the wonderful building company ISG installed a bike and scooter lock up area to encourage more of our children to travel to school more sustainably.&nbsp;</p>
<p>Children continue to learn about road safety and the school takes part in the local authority's Travel Smart week which happens twice a year.</p>
<p>&nbsp;</p>
<p>We also have cycle trainers from Bikeability who come in to school to teach children how to safely ride a bike.</p>
<p><a href="https://www.bikeability.org.uk/find-cycle-training/">CLICK HERE</a> to access further information about Bikeability</p>
<p><a href="https://www.derbyshire.gov.uk/transport-roads/road-safety/bicycles/county-rider/county-rider.aspx">CLICK HERE</a> to find out about County Rider - cycling training for people over 18</p>
<p><a href="https://www.derbyshire.gov.uk/leisure/countryside/access/cycling/cycling.aspx">CLICK HERE</a> to find out about cycle routes</p>
<p><a href="https://www.derbyshire.gov.uk/transport-roads/public-transport/public-transport.aspx">CLICK HERE</a> to find out about public transport</p>
<p>As a school we try to encourage children and families to be TRAVEL SMART on your way to school to try to reduce traffic and improve the safety for our children. Heath Primary School is positioned close to an A road and a highly populated residential area, so we encourage parents and pupils to be careful and considerate when parking nearby.</p>
<p></p>
<p>Below is a map of the area around the school where you can park and walk.</p>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/how_to_get_to_heath_primary_school.pdf" data-fileid="558"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">How_to_get_to_Heath_primary_School.pdf <i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
                <div id="pdf-view-558-5586936df28cfc3d" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/how_to_get_to_heath_primary_school.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
            ...
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        canvasContainer.appendChild(canvas);
                        if(first == 0){
                            $("#pdf-view-558-5586936df28cfc3d").height(canvas.height);
                            $("#pdf-view-loading-558-5586936df28cfc3d").hide();
                            $("#pdf-view-558-5586936df28cfc3d").show();
                        }
                        page.render(renderContext);
                        first = 1;
                    }
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-558-5586936df28cfc3d").addClass("single-page");
                        }
                        for (var num = 1; num <= pdfDoc.numPages; num++){
                            pdfDoc.getPage(num).then(renderPage);
                        }
