...
export const metadata: Metadata = {
  title: "Uniform  - Heath Primary SchoolSchoolzine",
};
...
<p>The schools’ uniform is worn by 99% of our children and can be worn all year round. As a school we have <span style="text-decoration: underline;">no intention</span> of sending children home or isolating them for not meeting this policy as some schools have done. We would instead support children and families who needed it. If your child is not wearing correct uniform, we would generally raise this with the parents unless it was appropriate to raise with the child.</p>
<p>Children should wear:</p>
<ul>
<li>A white/red polo shirt</li>
<li>A red cardigan, jumper or fleece (if required)</li>
<li>Grey or black trousers or skirt</li>
<li>Plain black school shoes/trainers</li>
</ul>
<p><span style="text-decoration: underline;">Further clarification</span></p>
<ul>
<li>
<div class="O0"><span>If your child feels more comfortable in joggers, then again black/unbranded is acceptable.</span></div>
</li>
<li>
<div class="O0"><span></span><span>We have never accepted denim as an option. </span></div>
</li>
<li>
<div class="O0"><span></span><span>There are </span><span>a number of</span><span> optional branded uniform items with the school logo on for sale such as jumpers, fleece jackets, reading record bags and sweatshirts available to purchase through the school office or online (further details to follow)</span></div>
</li>
<li>
<div class="O0"><span></span><span>Footwear should be safe to wear in school and so high heels/flip flops are not acceptable.</span></div>
</li>
</ul>
<div class="O0"><span></span><span></span><span></span><span style="text-decoration: underline;"><strong>Name Lables</strong></span><strong>&nbsp;</strong></div>
<p>Save time and money with one multipurpose name label for clothes, shoes, lunch boxes and all school items.</p>
<p>To order please click on the link button below.</p>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="http://www.stikins.co.uk" target="_blank" title="Click here to order STIKINS Name Labels" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to order STIKINS Name Labels</span></span></a></div>
<h2>Jewellery and Accessories</h2>
<p>Children are only allowed to wear:</p>
<ul>
<li>Small stud earrings, which must be removed for PE.</li>
</ul>
<p><em>A Safety Note – The Health and Safety at Work Act stipulates that NO child must wear earrings or any other form of jewellery whilst taking part in school organised P.E. activities. We therefore ask that children do not have their ears pierced during term time as this would exclude them from P.E. whilst their ears healed. Earrings CANNOT be taped over for PE lessons.</em></p>
<p>Please do not send your child to school in expensive watches or any jewellery. We do not allow children to wear items of jewellery or bring personal possessions to school. Unfortunately, we cannot take responsibility for lost or damaged possessions or clothing.</p>
<h2>PE kit</h2>
<p>Classes now have allocated PE days. On these days children should arrive in their PE kit and will not need a change of clothes. This will enable children to access longer PE sessions but you will need to ensure you are aware of what days your child has PE on.</p>
<p>Children should wear:</p>
<ul>
<li>A red or white T-shirt</li>
<li>Black shorts or joggers</li>
<li>Plimsolls or trainers</li>
<li>A warmer plain red/black sports top for the colder months</li>
</ul>
<p><span style="text-decoration: underline;">Further clarification</span></p>
<ul>
<li>Football strips are not appropriate PE wear</li>
<li>No jeans or denim shorts</li>
</ul>
<h2><span style="text-decoration: underline;">Ordering Online</span></h2>
<p>Items of uniform can also now be ordered and paid for through Parentpay – <a href="http://www.parentpay.com">www.parentpay.com</a>. If we have the items in stock we will call you to collect the following week or put an order through for the items.</p>
<p>As well as now ordering your uniform through Parentpay, you can also order school uniform through our main supplier, <a href="https://myclothing.com/heath-primary-school/17241.school">https://myclothing.com/heath-primary-school/17241.school</a>. School receive 5% back from these sales.</p>
<p>You can also purchase unbranded jumpers and cardigans from a number of other shops such as tesco/asda, we are unaware of any second hand retailers who supply at this point. But as a school we have a selection of used items available for a small donation. Please ask at the school office if we have anything suitable available.</p>
<p>We hope you’ll support the school to keep the children smart and reduce time spent missing lessons and making extra phone calls.</p>
<p>If you require any support with uniform don’t hestitate to get in touch with us at school through our office team on <a href="mailto:info@heath.derbyshire.sch.uk">info@heath.derbyshire.sch.uk</a> or call on 01246&nbsp;850277.</p>
<p>Don't forget that children should wear their PE kit to school on designated PE days.</p>
