...
export const metadata: Metadata = {
  title: "Protected Characteristics - Heath Primary SchoolSchoolzine",
};
...
<h1 style="text-align: left;"><span style="color: #ff0000;">Protected Characteristics</span></h1>
</div>
<div data-sb-image-container="1" style="text-align: left;"><span style="text-align: left;">Heath Primary School is committed to promoting equality, diversity and community cohesion. We aim to ensure that all members of the school and wider communities feel valued, respected and are offered opportunities to make maximum progress to achieve their full potential, whilst enabling them to play a full part in the diverse society in which we live. Our vision is encompassed in our values </span><strong style="text-align: left;">Respect<em>, Achieve, Together</em></strong><span style="text-align: left;">&nbsp;</span><span style="text-align: left;">and at Heath Primary School we aim for every child to feel valued, safe and happy – we want all our children to feel that they belong!</span></div>
<div data-sb-image-container="1" style="text-align: left;">
<p>Our Equality and Diversity Policy provides a framework for Heath Primary School’s community to meet the equality duties. This will guide the ways in which we aim to eliminate unlawful discrimination and harassment, promote equality of opportunity and promote good relations and positive attitudes between people of diverse backgrounds. We also believe it is very important that every child should be taught to have due regard for the feelings, wishes and rights of others - we want pupils to always show respect.</p>
<p><strong>The 2010 Equality Act makes it an offense to discriminate against a person due to their protected characteristic(s).</strong></p>
<p><strong>Under the Equality Act, there are nine Protected Characteristics:</strong></p>
<ul><li>Age</li>
<li>Disability</li>
...
<div data-sb-image-container="1" style="text-align: center;"><a href="https://uk.sz-cdn.net/heathprimary/media/1040/240424120639253/578x413/protected_characteristics_overview..png" data-lightbox="Protected_Characteristics_Overview..PNG" data-title="Protected_Characteristics_Overview..PNG" class="no-ajaxy" data-sb-image-container="1"><img src="/images/protected_characteristics_overview..png" alt="Protected_Characteristics_Overview..PNG" width="578" height="413" class=" szImg" data-object_id="1040" data-object_ref="sb_cms_media_file" data_reference="/images/media/1040/protected_characteristics_overview..png" data-lightboxed="true" data-externally-linked="false" data-custom-style-class="szImg" data-sb-image-container="1"></a></div>
<div data-sb-image-container="1" style="text-align: center;">
...
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/protective_characteristics_poster.pdf" data-fileid="1041"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Protective characteristics Poster <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/protective_characteristics_poster.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Protective characteristics Poster </span>
                                <span class="pdf-viewer-filesize">    3.18 MB <i class="fa fa-download"></i></span>
            </a>
        </div>
