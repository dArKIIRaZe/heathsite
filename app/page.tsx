...
export const metadata: Metadata = {
  title: "Home - Heath Primary SchoolSchoolzine",
};
...
<header id="header" class="transparent-header semi-transparent full-header">
	...
	<form action="/site-search" method="get" name="search-form" id="search-form">
		...
		<button type="submit">Search</button>
						...
						<section id="slider" class="slider-element swiper_wrapper full-screen clearfix" data-autoplay="7000" data-speed="650" data-loop="true" style="height: 475px;">

	

		<div class="swiper-container swiper-parent swiper-container-horizontal" style="cursor: grab;">
			<div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-800px, 0px, 0px);"><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" style="background-image: url(&quot;/heath/s5.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="4">
				<div class="container clearfix">
									</div>
			</div>
					...
					<div class="swiper-slide dark swiper-slide-active" style="background-image: url(&quot;/heath/s1.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="0">
				<div class="container clearfix">
											<div class="slider-caption slider-caption-center" style="top: 177.5px;">
					...
					<div class="swiper-slide swiper-slide-next" style="background-image: url(&quot;/heath/s2.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="1">
				<div class="container clearfix">
									</div>
			</div>
					...
					<div class="swiper-slide" style="background-image: url(&quot;/heath/s3.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="2">
				<div class="container clearfix">
									</div>
			</div>
					...
					<div class="swiper-slide" style="background-image: url(&quot;/heath/s4.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="3">
				<div class="container clearfix">
									</div>
			</div>
					...
					<div class="swiper-slide swiper-slide-duplicate-prev" style="background-image: url(&quot;/heath/s5.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="4">
				<div class="container clearfix">
									</div>
			</div>
		
					<div class="swiper-slide dark swiper-slide-duplicate swiper-slide-duplicate-active" style="background-image: url(&quot;/heath/s1.jpg&quot;); height: 475px; width: 800px;" data-swiper-slide-index="0">
				<div class="container clearfix">
											<div class="slider-caption slider-caption-center" style="top: 177.5px;">
...
<div class="content-wrap">
		...
		<div class="clearfix ">
		<div class=" nobottommargin clearfix" tabindex="0" role="region">
...
<div class="col-md-3" style="background-image: url('/images/left.jpg');"></div>
<div class="col-md-6 col-padding">
<h1 style="text-align: center;"><span style="font-size: 20px;"><strong></strong></span></h1>
<h1 style="text-align: center;"><span style="font-size: 24px;"><strong>Our website is currently under construction and not being updated at the moment.</strong></span></h1>
<h1><span></span></h1>
<h1><span>Welcome</span><span></span></h1>
<p><span>I would like to warmly welcome you to Heath Primary School. </span></p>
<p>Our motto reflects our vision.</p>
<p><strong>Respect, Achieve, Together.</strong></p>
<p>It&nbsp;is simple and was created through partnership with parents, pupils, staff and governors. As a school we want the best of futures for our pupils, we want them to find out about, be inspired by and enjoy the world they live in.&nbsp;We want them to be citizens who care for others and for&nbsp;their world. We want them to&nbsp;know the value of sharing their time, their knowledge and their experiences to support others.&nbsp;We want them to have the confidence to recognise and grasp opportunities that they are given, and to develop an&nbsp;understanding&nbsp;that they can make a&nbsp;positive impact on the world in which they live.</p>
<p>We strive to provide a happy, caring, safe and stimulating learning environment, where pupils are encouraged and nurtured to thrive socially, emotionally and academically to achieve the best they possibly can.</p>
<p>We are proud to be part of Embark Federation, a family of schools across Derbyshire. We work closely with the schools in our Trust to ensure that our school is at the heart of the community and to live our values of Family, Integrity, Teamwork and Success. Our children work towards their Embark award throughout their time with Heath Primary to celebrate a range of experiences.</p>
<p>Visits to our school are warmly welcomed and can be arranged through the school office.</p>
<p>If you wish to make a suggestion, or if<span> you require a paper copy of anything that is shown on our web site, </span>or have any comments for our staff or school, please contact the school office on 01246 850277 or via email on <a href="mailto:enquiries@heath.derbyshire.sch.uk">office@heath.derbyshire.sch.uk</a>&nbsp;with the details and we will get back to you shortly.</p>
<p style="text-align: center;"></p>
<p></p>
<p>Jonathan Lynch<br>Executive Headteacher</p>
<p></p>
<p>Heath Primary School</p>
<p>Slack Lane</p>
<p>Heath</p>
<p>Chesterfield</p>
<p>S44 5RH</p>
...
<div data-sb-image-container="1"><a href="https://www.ceop.police.uk/safety-centre/" class="sz-user-link linknewNode[0]-url no-ajaxy"><img src="/images/ceop.png" alt="CEOP.png" width="300" height="213" class=" szImg" data-object_id="81" data-object_ref="sb_cms_media_file" data_reference="/images/media/81/ceop.png" data-lightboxed="true" data-externally-linked="false" data-custom-style-class="szImg" data-sb-image-container="1" style="display: block; margin-left: auto; margin-right: auto;"></a></div>
</div>
<p></p>
<p></p>
</div>
<div class="col-md-3" style="background-image: url('/images/right.jpg');"></div>
