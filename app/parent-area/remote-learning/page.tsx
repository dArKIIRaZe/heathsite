...
<p style="text-align: center;"><span style="font-size: 18px;"><strong>Remote Learning</strong></span><strong></strong></p>
<div>
<p>Since the pandemic Heath primary School has a plan in place should remote learning be required again.&nbsp;Our main platform is Class Dojo, where parents have a log in to access their children's work, ask any questions and upload work for their teachers to see.</p>
<p>If anyone has any concerns or worries about&nbsp;the work then please get in touch&nbsp;as we want&nbsp;to help&nbsp;in what is a tricky&nbsp;time. Either message your child's class teacher or myself on Dojo or email us on <a href="mailto:health@heath.derbyshire.sch.uk">info@heath.derbyshirre.co.uk</a></p>
<p></p>
<p>Take care</p>
<p>Mr Lynch and all the team at HPS</p>
<p></p>
<p>At Heath Primary School we have used a tiered approach to home learning should this be needed by you to support remote learning. This follows a similar model to the one used during the lock down and hopefully has enough to help you support your child at home.</p>
</div>
<p>We have broken the support into three stages, whereby each offers support at a level we feel is appropriate.</p>
<p><strong>Stage 1:&nbsp;</strong></p>
<p>Here you will have a menu of items to use and keep your child engaged with their learning in the short term, such as when your child's class has to close at short notice.</p>
<p>If you need further support or a pack printing out then don't&nbsp;hesitate to get in touch with the school using the <a href="mailto:health@heath.derbyshire.sch.uk">info@heath.derbyshire.sch.uk</a>&nbsp;email address. Clearly you can access more resources, such as those available through Oak Academy, or use the Stage 2 resources but be aware the latter wont be updated every two weeks.</p>
<p><strong>Stage 2: </strong></p>
<p><span>This plan will be shared at the time by the class teachers and will closely follow the themes and topics in school. There may be a delay for this to be shared if we close a suddenly and you can access the other ideas from stage 1 in the interim.<br></span><span></span></p>
<p>We will continue to revise and improve our home learning&nbsp;provision&nbsp;and value any feedback. Please email on <a href="mailto:health@heath.derbyshire.sch.uk">info@heath.derbyshire.sch.uk</a>&nbsp;if you have any comments.</p>
<p></p>
<p>You can access the pages through the top menu, parent area/ home learning/</p>
<div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/zoom_agreement_2021.pdf" target="_blank" title="Please Click here to view our Zoom agreement 2021" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Please Click here to view our Zoom agreement 2021</span></span></a></div>
</div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/information_for_parents_about_remote_education_january_2021.pdf" target="_blank" title="Please Click here for Information for Parents about Remote Education - January 2021" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-external-link"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Please Click here for Information for Parents about Remote Education - January 2021</span></span></a></div>
<p></p>
<p></p>
</div>
</div>
