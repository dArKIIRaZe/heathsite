...
export const metadata: Metadata = {
  title: " Embark Award - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <p><span style="font-size: 18px;"><strong>Embark Award</strong></span></p>
<div></div>
<p>The Embark Award is part of our commitment as a trust to the wider offer for our children. It comprises of 100 activities for children to complete around our 4 core beliefs of Family, Integrity, Teamwork and Success.</p>
<p><span>These activities encourage family learning at home however, we realise some children do not have the support so the activities are designed so the majority can be done in school also so that children have a breadth of experiences in their primary years.</span></p>
<p><span>Children will work towards their Bronze Award –40 activities, Silver Award –60 Activities and then finally their Gold Award –90 Activities.</span></p>
<p><span>In school we will have activities we will try to cover during the term and we will share these aroudn the school and on Class Dojo. We also know there are a lot here, so we will be sharing suggested activies for each half term as well if you would like to do them.&nbsp;</span></p>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/embark_award.pdf" data-fileid="300"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Embark_Award.pdf <i class="fa fa-download pdf-flyer-edit"></i><i class="fa fa-eye pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/embark_award.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Embark_Award _pdf</span>
                                <span class="pdf-viewer-filesize">    1.15 MB <i class="fa fa-download"></i></span>
            </a>
        </div>
                <div id="pdf-view-300-3006936df57601c8" class="pdf-view HTML-only" style="height: 800px; width: 100%;">
        <iframe src="/pdfs/embark_award.pdf" type="application/pdf" style="width: 100%; height: 100%; border: none;" title="PDF Viewer"></iframe>
        </div>
        <script>
            $(function () {
                function renderPDF(url, canvasContainer, options) {
                    ...
                    function renderPage(page) {
                        ...
                        if(first == 0){
                            $("#pdf-view-300-3006936df57601c8").height(canvas.height);
                            $("#pdf-view-loading-300-3006936df57601c8").hide();
                            $("#pdf-view-300-3006936df57601c8").show();
                        }
                    ...
                    function renderPages(pdfDoc) {
                        if(pdfDoc.numPages == 1){
                            $("#pdf-view-300-3006936df57601c8").addClass("single-page");
                        }
                ...
                renderPDF('/pdfs/embark_award.pdf', document.getElementById('pdf-view-300-3006936df57601c8'));
            });
        </script>
