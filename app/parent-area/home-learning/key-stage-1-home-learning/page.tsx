...
export const metadata: Metadata = {
  title: "Key Stage 1 Remote Learning - Heath Primary SchoolSchoolzine",
};
...
<div class="content-wrap">
                ...
                <div class="clearfix container content-wrap">
                                    <p><span>Welcome to KS1 (Years 1 and 2) Remote learning page. Here you can find our set tasks for different stages to support you if your child is not able to attend due to Covid-19.</span></p>
<p><strong>Stage 1:</strong></p>
<p>Here are a range of activities to complete with your child should&nbsp;you have to use remote learning.</p>
<div>
<div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/home_learning_ks1_stage_1.pdf" target="_blank" title="Click here to download Home Learning KS1 - Stage 1" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download Home Learning KS1 - Stage 1</span></span></a></div>
</div>
</div>
<div data-sb-image-container="1"><a href="https://ttrockstars.com/" data-sb-image-container="1" target="_blank" rel="noopener"></a>
<div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/home_learning_ks1_autumn_2_stage_1_.pdf" target="_blank" title="Click Here for Home Learning KS1 Autumn 2 - Stage 1 " class="sz-web-a" rel="noopener"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click Here to download Home Learning KS1 Autumn 2 - Stage 1 </span></span></a></div>
</div>
<div class="wysiwyg sz-web-link no-url bg-sub mceNonEditable"><a href="/pdfs/home_learning_ks1_summer_1_stage_1.pdf" target="_blank" title="Click here to download Home Learning KS1 Summer 1 - Stage 1" class="sz-web-a"><i class="fa fa-pencil  edit-web-link"></i><i class="fa fa-minus-circle  deleted-web-link"></i><span class="sz-web-icon-wrap"><span class="sz-web-icon"><i class="fa fa-file-pdf-o"></i></span></span><span class="sz-web-inline"><span class="sz-web-title">Click here to download Home Learning KS1 Summer 1 - Stage 1</span></span></a></div>
<div>
<div class="pdf-viewer-heading-wrap pdf-flyer-edit mceNonEditable">
<div class="wysiwyg-only pdf-viewer-heading pdf-flyer-edit"><a class="pdf-viewer-link pdf-flyer-edit" href="/pdfs/home_learning_stage_1_ks1_spring_1.pdf" data-fileid="470"> <i class="fa fa-file-pdf-o pdf-flyer-edit"></i><span class="pdf-viewer-title pdf-flyer-edit">Home Learning Stage 1 KS1 Spring 1 <i class="fa fa-download pdf-flyer-edit"></i></span><span class="pdf-viewer-filesize pdf-flyer-edit"></span><i class="fa fa-pencil pdf-flyer-edit edit-pdf-flyer"></i><i class="fa fa-minus-circle pdf-flyer-edit deleted-pdf-flyer"></i></a></div>
<div class="wysiwyg-hide">
            <div class="pdf-viewer-heading">
            <a class="pdf-viewer-link" href="/pdfs/home_learning_stage_1_ks1_spring_1.pdf" download="download">
                <i class="fa fa-file-pdf-o"></i>
                <span class="pdf-viewer-title">Home Learning Stage 1 KS1 Spring 1</span>
                                <span class="pdf-viewer-filesize">    423.96 KB <i class="fa fa-download"></i></span>
            </a>
        </div>
...
<p></p>
<p><span>This stage is for your child if your child’s class has to close. Your child's class teacher will share the planning&nbsp;if a bubble needs to close. If you have any questions about the work you can liaise with their teacher via Dojo.</span></p>
<div>
<p></p>
<p></p>
</div>
